...
import ml_worker  # Import the worker module
...
def process_message_route():
    ...
    bot_response = ml_worker.process_prompt(user_message)  # Process the user's message using the worker module
...
def process_document_route():
    ...
    ml_worker.process_document(file_path)  # Process the document using the worker module
